...
public class HttpRequest {
    ...
    public static String sendGet(String url,String service_name,JSONObject header, String param) {
        String result = "";
     ...
     * 
     */
    public static String sendPost(String url,String service_name,JSONObject header, String param) {
